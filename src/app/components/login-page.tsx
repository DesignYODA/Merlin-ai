...
export function LoginPage() {
  ...
  return (
    <div
      className="dark flex items-center justify-center min-h-screen w-screen bg-[#0a0a12]"
    ...
    >
      ...
      <div className="relative w-full max-w-sm mx-4">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-white text-2xl font-semibold tracking-tight">Merlin AI</h1>
        ...
        {/* Card */}
        <div className="bg-[#0f0f13] border border-[#1e1e2e] rounded-2xl p-6 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div className="relative">
              ...
              <input
                ...
                required
                autoFocus
                className="w-full bg-[#1a1a28] border border-[#2a2a3e] rounded-lg pl-9 pr-4 py-2.5 text-white placeholder-[#3a3a50] outline-none focus:border-[#ec5d25]/60 focus:ring-1 focus:ring-[#ec5d25]/30 transition-all"
        ...
        <p className="text-center text-[#333348] mt-6" style={{ fontSize: "0.7rem" }}>
          Merlin AI · Itilite internal tool
        </p>
      </div>
    </div>
  );
