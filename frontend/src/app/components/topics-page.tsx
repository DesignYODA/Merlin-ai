...
function ZoomableSunburst({
  ...
  return (
    <div className="bg-app-card border border-[#1e1e2e] rounded-xl p-6">
      {/* Header row */}
...
export function TopicsPage() {
  ...
  return (
    <div className="p-8 space-y-8">
      ...
      {/* Search */}
      <div className="flex items-center gap-2 bg-app-card border border-[#1e1e2e] rounded-xl px-4 py-2.5">
      ...
      {selectedTopic && selectedTopicCalls.length > 0 && (
        <div className="bg-app-card border border-[#ec5d25]/20 rounded-xl p-6">
          <h3
          ...
          <div className="space-y-3">
            {selectedTopicCalls.map((call) => (
              <div
                key={call.id}
                className="flex items-center justify-between p-3 rounded-lg bg-app-surface hover:bg-app-elevated transition-colors"
              >
