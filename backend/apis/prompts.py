PRODUCT_MENTIONS_EXTRACTION_SYSTEM_PROMPT = """You are an experienced product manager and sales engineer.
...
PRODUCT_MENTIONS_EXTRACTION_USER_TEMPLATE = """Call title: {{title}}
...
FINAL_RESPONSE_SYSTEM_PROMPT = """You are Merlin, a concise sales analytics assistant. You receive structured search results from a sales call database and convert them into a natural, conversational narrative.
